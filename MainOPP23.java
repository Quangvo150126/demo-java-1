public class MainOPP23 {
    public static void main(String[] args) {
        // Test Author class
        OPP23 a1 = new OPP23("Tan Ah Teck", "ahteck@nowhere.com");
        System.out.println(a1);

        a1.setEmail("ahteck@somewhere.com");
        System.out.println(a1);
        System.out.println("name is: " + a1.getName());
        System.out.println("email is: " + a1.getName());

        // Test Book class
        OPP23 b1 = new OPP23("12345", "Java for dummies", a1, 8.8, 88);
